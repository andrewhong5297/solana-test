...
impl Processor {
    ...
    fn process_init_escrow(
        ...
        let rent = &Rent::from_account_info(next_account_info(account_info_iter)?)?; //rent is a sysvar and can be referenced anytime
        ...
        //transfer ownership of temp token account to this PDA instead
        escrow_info.expected_amount = amount;
